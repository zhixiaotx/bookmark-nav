...
| 📚 分组导航 | 多套数据源按“分组 → 分类 → 站点”层级组织，可在顶部分组标签间切换 |
...
`favicon.im` / MyHKW / iowen / 百度 / AFMax / La4 / Vvhan / xinac / favicon.vip / Cravatar / direct(站点直连 /favicon.ico) / DuckDuckGo / FaviconExtractor / FaviconPub / Google S2 / Clearbit / DDG Icons / IconHorse / Iconify / logo_surf(文字) / custom(自定义)。
